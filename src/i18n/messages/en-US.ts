export default {
  ...
  routes: {
    ...
    cron: 'Cron',
    models: 'Models',
    modelQuotaMonitor: 'Model Quota Monitor',
    channels: 'Channels',
    skills: 'Skills',
  ...
  pages: {
    ...
    modelQuotaMonitor: {
      title: 'Model Quota Monitor',
      subtitle: 'MVP first: reuse the existing model catalog and real usage aggregation to estimate remaining context headroom.',
      refresh: 'Refresh monitor',
      lastUpdated: 'Last updated: {time}',
      unknown: 'Unknown',
      noData: 'No model quota data yet',
      limitLabel: 'Sample sessions',
      dateRangeDays: 'Usage days',
      cards: {
        models: 'Models',
      ...
      table: {
        ...
        remainingTokens: 'Estimated remaining',
      ...
      status: {
        ...
        warning: 'Near limit',
        danger: 'Low headroom',
        unknown: 'Missing context info',
      },
      hints: {
        estimation: 'This is an estimate based on model context window and recent session usage, not the provider account quota.',
        missingContext: 'Models without a context window cannot show a remaining percentage yet.',
      },
    },
    sessions: {
      roles: {
