export default {
  ...
  pages: {
    ...
    modelQuotaMonitor: {
      title: '模型余量监控',
      subtitle: '先做最小可用版：基于现有模型清单与真实 usage 聚合，快速看还有多少上下文余量可用。',
      refresh: '刷新监控',
      ...
      table: {
        ...
        remainingTokens: '预估余量',
        remainingPercent: '余量占比',
        sessionCount: '会话数',
        status: '状态',
      },
      status: {
      ...
      hints: {
        estimation: '当前余量是基于模型 context window 与最近会话 usage 聚合做的估算，不代表供应商账户配额。',
        missingContext: '没有 context window 的模型暂时无法给出余量百分比。',
      },
    },
    sessions: {
      roles: {
